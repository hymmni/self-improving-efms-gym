...
실행:
  python -m mani_sim.policies.diffusion.dstg_reward \
...
from mani_sim.utils.checkpoints import load_epoch_checkpoint, load_run_config
...
def _episode_split(dataset, val_fraction, seed):
    ...
    From: mani_sim/src/mani_sim/scripts/train_dstg.py의 _episode_split — 같은
...
class DstgReward:
    ...
    def _from_predictor(cls, predictor, num_bins, statistic="mean", cvar_alpha=0.8,
        ...
        (작은 랜덤) DstgPredictor를 직접 감싼다(mani_sim/tests/test_dstg_reward.py).
        """
