...
from square_assembly.datasets.labels import LABEL_INTV, LABEL_ROLLOUT, relabel_preintv
...
def _start_async_inference(predict_fn, obs_horizon, merger_name, te_coeff):
    ...
    from square_assembly.inference.client_manager import ClientManager
    from square_assembly.inference.merger import make_merger
    from square_assembly.inference.obs_provider import ObsProvider
    from square_assembly.inference.policy_server import PolicyServer
